...
def main(args):
    ...
    if args.item_indexing == 'sequential':
        ...
        reindex_user_seq_dict, item_map = indexing.sequential_indexing(args.data_path, args.dataset, user_sequence_dict,
        ...
        print(
            f"Reindex data with collaborative indexing method with token_size {args.collaborative_token_size} and {args.collaborative_cluster} cluster")
        reindex_user_seq_dict, item_map = indexing.collaborative_indexing(args.data_path, args.dataset,
                                                                          user_sequence_dict, \
                                                                          args.collaborative_token_size,
                                                                          args.collaborative_cluster, \
                                                                          args.collaborative_last_token,
                                                                          args.collaborative_float32)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tasks", type=str, default='sequential,straightforward',
    ...
    parser.add_argument("--sequential_order", type=str, default='original',
                        help='The rank of user history during indexing')
    parser.add_argument("--collaborative_token_size", type=int, default=100,
